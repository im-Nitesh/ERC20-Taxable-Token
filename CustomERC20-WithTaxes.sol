...
contract Customerc20 is Ownable {
    ...
    string private constant _name = "customerc";
    string private constant _symbol = "cstm";
    ...
    uint256 public _buyTaxPercentage = 5000;        //1000 = 5%
    uint256 public _sellTaxPercentage = 10000;       //1000 = 10%
    uint256 public _liquidityTaxPercentage = 1000;  //1000 = 1%  no need this line of code
    uint256 public _burnTaxPercentage = 25000;       //1000 = 25%



    uint256 public _liquidityTaxShare = 67000;      //67000 = 67%
 
    uint256 public _totalTaxPercent;
 
    uint256 public marketingPercent = 33000;        //50000 = 33%
    ...
    function setBuyTaxPercentage(uint256 taxPercentage) external onlyOwner {
        ...
        _totalTaxPercent = _buyTaxPercentage+_sellTaxPercentage;
        ...
        if (takeFee) {
            if (automatedMarketMakerPairs[sender] && isBuy) {
                if (!_isExcludedFromFee[recipient]){
                    ...
                    burnTax = _calculateTax(buyTax, _burnTaxPercentage);
                ...
                if (!_isExcludedFromFee[sender]){
                    ...
                    burnTax = _calculateTax(sellTax, _burnTaxPercentage);
